...
- **Dataset = scripts/build_grpo.py output** (prompt = student system+user; the
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--data", default="data/grpo/train.jsonl", help="build_grpo.py jsonl")
    p.add_argument("--output-dir", default="/workspace/gemma-menu-grpo",
                   help="persistent (RunPod network volume) dir for the GRPO adapter")
